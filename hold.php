    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <a href="care.html"><img class="first-slide" src="images/ba2.jpg" alt="First slide" width="100%"></a>
       
        </div>
        <div class="item">
          <a href="care.html"><img class="second-slide " src="images/ba.jpg" alt="Second slide" width="100%"></a>
         
        </div>
        <div class="item">
         <a href="hold.html"> <img class="third-slide " src="images/ba1.jpg" alt="Third slide" width="100%"></a>
...
<div class="kic-top ">
	...
	<div class="kic ">
		...
		<div class="col-md-4 kic-top1">
			<a href="single.html">
				<img src="images/ki6.jpg" class="img-responsive" alt="" width="100%"></a>
			</a>
			<h6>Clips</h6>
		...
		<div class="col-md-4 kic-top1">
			<a href="single.html">
				<img src="images/ki7.jpg" class="img-responsive" alt="" width="100%"></a>
			</a>
			<h6>Cleaning Wear</h6>
			<p>Nam libero tempore</p>
		</div>
		<div class="col-md-4 kic-top1">
			<a href="single.html">
				<img src="images/ki8.jpg" class="img-responsive" alt="" width="100%"></a>
			</a>
			<h6>Toothbrush</h6>
			<p>Nam libero tempore</p>
		</div>
