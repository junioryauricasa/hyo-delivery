	...
	<div class="container">
		...
		<div class="clearfix"></div>
			<div class="footer-bottom">
				...
				<ul class="social-fo">
					<li><a href="https://www.facebook.com/HYO-Delivery-872518679584383/" class=" face"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
				...
				<div class=" address">
					...
					<div class="col-md-4 fo-grid1">
						<p><i class="fa fa-phone" aria-hidden="true"></i>+51 940 285 341</p>	
					</div>
					<div class="col-md-4"></div>
					<!--div class="col-md-4 fo-grid1">
		...
		<div class="copy-right">
			<p> &copy; 2017 Huancayo Delivery. Todos los Derechos Reservados | Diseñado por  <a href="http://devhuayra.com" class="h4"> devhuayra</a></p>
		</div>
	</div>
</div>
<!-- //footer-->
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
							...
							<div class="col-md-7 span-1 ">
								...
								<h4 class="quick">Quick Overview:</h4>
								<p class="quick_desc"> 
									Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim assum. Typi non habent claritatem insitam; es
								</p>
								<div class="add-to">
...
<script type="text/javascript">
    (function () {
        var options = {
            facebook: "872518679584383", // Facebook page ID
            whatsapp: "+51 940 285 341", // WhatsApp number
