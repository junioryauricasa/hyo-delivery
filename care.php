    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <a href="#"><img class="first-slide" src="images/ba1.jpg" alt="First slide" style="width: 100%"></a>
       
        </div>
        <div class="item">
          <a href="#"><img class="second-slide " src="images/ba.jpg" alt="Second slide" style="width: 100%"></a>
         
        </div>
        <div class="item">
          <a href="#"><img class="third-slide " src="images/ba2.jpg" alt="Third slide" style="width: 100%"></a>
